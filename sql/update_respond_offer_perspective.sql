-- UPDATE: Replace respond_offer function with perspective-aware messages
-- This should be run in Supabase to update the existing function
...
BEGIN
  ...
  -- Generate system message based on action with perspective awareness
  v_system_text := CASE 
