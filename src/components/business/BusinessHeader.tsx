...
export default function BusinessHeader({ business, isOwner }: Props) {
  ...
  return (
    <div className="bg-white">
      {/* Banner Image */}
      <div className="relative h-24 md:h-28 lg:h-32 w-full bg-gradient-to-r from-gray-800 to-gray-600">
        ...
        {isOwner && (
          <Link
            ...
            className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg hover:bg-white transition-colors flex items-center gap-2 text-sm font-medium"
          >
