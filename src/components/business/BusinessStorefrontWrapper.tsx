    ...
    async function fetchBusinessProfile() {
      try {
        ...
        const { data: profile, error: profileError } = await supabase
          .from("profiles")
          .select("id, name, email, avatar, background_image, about, county, country, account_type, business_verified, total_sales, avg_response_time_minutes, response_rate, created_at")
          .eq("id", profileId)
          .single();
        ...
        const businessProfile: BusinessProfile = {
          ...
          county: (profile as any).county ?? null,
          ...
          brand_primary_color: businessInfo.brand_primary_color,
          brand_secondary_color: businessInfo.brand_secondary_color,
          brand_accent_color: businessInfo.brand_accent_color,
