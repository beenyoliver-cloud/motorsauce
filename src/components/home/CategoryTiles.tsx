      ...
      {tiles.map((t, idx) => {
        ...
        return (
          <Link
            key={t.label}
            href={t.href}
            className="group relative overflow-hidden rounded-xl p-3 sm:p-4 min-h-[130px] flex flex-col justify-between text-white shadow-sm hover:-translate-y-1 transition-all duration-300 animate-fadeInUp"
            style={{
