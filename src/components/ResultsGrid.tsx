      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="animate-pulse border border-gray-200 rounded-md overflow-hidden">
            ...
            <div className="flex items-center gap-3 p-2 sm:block sm:p-3">
              <div className="w-[120px] h-[120px] flex-shrink-0 bg-gray-100 rounded sm:aspect-[3/2.5] sm:h-auto sm:w-full" />
              <div className="flex-1 space-y-2 sm:mt-2 sm:space-y-1.5">
