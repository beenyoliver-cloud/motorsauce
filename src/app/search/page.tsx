        ...
        <div className="space-y-4 sm:space-y-6 px-3 sm:px-4 md:px-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-[11px] uppercase tracking-[0.25em] text-gray-500 flex items-center gap-2">
              ...
              <div className="flex flex-wrap items-center gap-3 justify-end">
                ...
                {activeTab === "sellers" && (
                  <div className="flex items-center gap-2 text-sm text-gray-700 bg-gray-50 rounded-full border border-gray-200 px-3 py-1.5">
                    Sort sellers
                    <select
                      value={sellerSort}
          ...
          <div className="grid gap-4 md:grid-cols-[minmax(0,3fr)_minmax(0,1.2fr)]">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                {TRENDING_QUERIES.map((term) => (
                  <button
                    ...
                    className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs font-semibold text-gray-800 hover:border-gray-300 transition"
                  >
                    {term}
            ...
            <div className="hidden md:flex rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
              <LiveActivityFeed />
            </div>
          </div>
