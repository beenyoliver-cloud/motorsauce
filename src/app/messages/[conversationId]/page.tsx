            ...
            <div className="flex-1 min-w-0">
              ...
              {conversationInfo?.listing && (
                <Link
                  ...
                  className="text-sm text-gray-600 hover:text-yellow-600 flex items-center gap-1 truncate"
                >
                  <Package className="w-3 h-3 shrink-0" />
                  <span className="truncate">{conversationInfo.listing.title}</span>
                </Link>
              )}
            </div>

            {conversationInfo?.listing?.image && (
              <Link href={`/listing/${conversationInfo.listing.id}`} className="shrink-0">
                <img
