...
function SellForm() {
  ...
  function onPickFiles(list: FileList | null) {
    ...
    setImages(newTotal.slice(0, 12)); // cap at 12 images
  }
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
            ...
            >
              <span className="font-medium text-gray-900">
                {isVehicleSpecific ? "Vehicle Details" : "Not Vehicle Specific"}
              </span>
              <span className={`text-xl text-gray-600 transition-transform ${vehiclesExpanded ? "rotate-180" : ""}`}>›</span>
            </button>
            
            {vehiclesExpanded && (
              <div className="px-4 py-4 border-t border-gray-200 bg-white space-y-4">
                {isVehicleSpecific && (
                  <p className="text-xs text-gray-600">These details help buyers find your part</p>
                )}
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          >
            ...
            <div className="text-xs text-gray-600">
              Up to 12 images • JPG/PNG/WebP • Max {Math.round(MAX_FILE_SIZE / 1024 / 1024)}MB each • {Math.round(MAX_TOTAL_SIZE / 1024 / 1024)}MB total
            </div>
            <input
              type="file"
              accept="image/*"
